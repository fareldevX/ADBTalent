export const getEmailTemplate = (username, url, type) => {
  const config = {
                    ...
                    <tr>
                      <td align="center" style="padding: 40px 40px 20px 40px;">
                        <div style="background-color: #eef2ff; width: 64px; height: 64px; border-radius: 20px; line-height: 64px; display: inline-block;">
                          <span style="font-size: 32px; color: #4f46e5; font-weight: bold;">A</span>
                        </div>
                        <h1 style="margin-top: 20px; color: #1e293b; font-size: 24px; font-weight: 800; letter-spacing: -0.5px;">ADBTalent</h1>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td style="padding: 0 60px 40px 60px; text-align: center;">
                        ...
                        <p style="color: #64748b; font-size: 16px; line-height: 1.6; margin-bottom: 32px;">
                          ...
                          Thank you for ${type === "verify" ? "registering an account" : "requesting a password reset"} with ADBTalent. Please click the button below to ${type === "verify" ? "verify your email address" : "reset your password"}.
                        </p>
                    ...
                    <tr>
                      <td style="background-color: #f8fafc; padding: 30px; text-align: center;">
                        <p style="color: #cbd5e1; font-size: 12px; margin: 0; font-weight: 600; text-transform: uppercase; letter-spacing: 1px;">
                          &copy; 2026 ADBTalent Platform. All Rights Reserved.
                        </p>
                      </td>
                    </tr>
